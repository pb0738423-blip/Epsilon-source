...
Authentication: Client authenticates the server using server’s RSA public key.
...
Integrity: The possible message alteration in transit should not go undetected by the communicating parties. Again, you can only use a keyed hash mechanism to achieve this.
Technical Specs
* Python3
* SHA256
